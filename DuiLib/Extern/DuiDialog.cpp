...
UINT CDuiDialog::MessageBox( LPCTSTR lpText, UINT uIcon/* = MB_ICONWARNING */, LPCTSTR lpCaption /*= _T("ÌáÊ¾")*/, UINT uType /*= MB_OK */,LPCTSTR lpBtnYesText/*=_T("ÊÇ")*/,LPCTSTR lpBtnNoText/*=_T("·ñ")*/) {
