...
namespace DuiLib
{
	...
	public:
		...
		virtual void DocumentComplete(BSTR &title,BSTR &url){}
		...
		virtual void TitleChange(BSTR &title,void *data=NULL){}
		virtual void FaviconChange(wstring &path, void *data=NULL){};
