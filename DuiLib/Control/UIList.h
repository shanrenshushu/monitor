...
public:
	...
	virtual void SetWillSelect(bool bSelect) = 0;
	virtual bool IsWillSeleted() = 0;
};
...
public:
	...
	void SetKeyDownUsed(bool bflag = false);
protected:
...
public:
	...
	void SetWillSelect(bool bSelect){m_WillSel = bSelect;Invalidate();}
	bool IsWillSeleted(){return m_WillSel;}
