...
namespace DuiLib
{
	...
	CDuiString COptionUI::GetClass() const
	{
		return _T("OptionUI");
	}
	...
	void COptionUI::Selected(bool bSelected, bool bOnlyChangeSelectedState)
	{
	...
	void COptionUI::PaintStatusImage(HDC hDC)
	{
		...
		/*  Óë »æÖÆÑ­Ðò£º±³¾°ÑÕÉ«->±³¾°Í¼->×´Ì¬Í¼->ÎÄ±¾->±ß¿ò ÏàÎ¥±³£¬ ÔÝÊ±×¢ÊÍµô */
...
Label_ForeImage:
	...
	{
		m_uTextStyle |= DT_SINGLELINE | DT_VCENTER | DT_WORD_ELLIPSIS ;
