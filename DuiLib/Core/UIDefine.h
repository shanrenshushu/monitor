...
#define DUI_MSGTYPE_DOWNLOADIMG            (_T("downloadimg"))
...
#define DUI_MSGTYPE_COMBOACITVE 		   (_T("comboactive"))
...
//定义图片下载消息的控件名称--执行函数宏
#define DUI_ON_DUI_DOWNLOADIMG_CTRNAME(ctrname,memberFxn)                            \
	{ DUI_MSGTYPE_DOWNLOADIMG,ctrname,DuiSig_vn,(DUI_PMSG)&memberFxn },          \
