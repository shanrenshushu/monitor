...
public:
	...
	bool DeselectOptionGroup(LPCTSTR pStrGroupName);
	void SelectFromOptionGroupByName(LPCTSTR pStrGroupName, LPCTSTR pstrName, bool bSelected, bool bOnlyChangeSelectedState = false);
	...
	CControlUI* GetNewHover(){return m_pNewHover;}
...
private:
	...
	static CControlUI* CALLBACK __FindControlFromTabEx(CControlUI* pThis, LPVOID pData);
...
private:
    ...
    CControlUI* m_pRoot;
    CControlUI* m_pFocus;
	CControlUI* m_pNewHover;
    CControlUI* m_pEventHover;
    CControlUI* m_pEventClick;
    CControlUI* m_pEventKey;

	CControlUI* m_pFocusNeed;
    //
...
public:
	...
	typedef CControlUI* (*cNodeCreator)();
	typedef std::map<std::wstring, cNodeCreator> cNameCreatorMap;
	static cNameCreatorMap mNameCreatorMap;
	static void RegisterNodeClass(const std::wstring& name, cNodeCreator creator);
	static bool NodeClassExists(const std::wstring& name);
	static CControlUI* CreateControl(const std::wstring& name);
};
