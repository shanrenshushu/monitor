...
public:
	...
	virtual CControlUI*GetDrawForComBoControl();
	virtual void SetOnlyDrawChild(bool only){m_bIsOnlyDrawChild =only;}
	virtual bool IsOnlyDrawChild(){return m_bIsOnlyDrawChild;}
