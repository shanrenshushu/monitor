...
tstring	CImagePlotImpl::GetAbsoluteDataTitle( int which )
{
...
/*
bool	CImagePlotImplI::OnLButtonDown( HWND hWnd, POINT point )
{
...
bool	CImagePlotImplI::OnLButtonUp( HWND hWnd, POINT point )
{
...
bool	CImagePlotImplI::OnLButtonDblClk( HWND hWnd, POINT point )
{
	return false;
}
