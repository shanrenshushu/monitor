...
public:
	...
	tstring		GetAbsoluteDataTitle( int which );
...
class CImageHandler : public CHandler
{
public:
...
template<typename ImagePlotImplT>
bool	CImageHandler<ImagePlotImplT>::OnLButtonDown( HWND hWnd, POINT point )
{
...
template<typename ImagePlotImplT>
bool	CImageHandler<ImagePlotImplT>::OnLButtonUp( HWND hWnd, POINT point )
{
	ImagePlotImplT *pT=static_cast<ImagePlotImplT *>(this);
...
template<typename ImagePlotImplT>
bool	CImageHandler<ImagePlotImplT>::OnLButtonDblClk( HWND hWnd, POINT point )
{
	return false;
}
...
template<typename ImagePlotImplT>
bool	CImageHandler<ImagePlotImplT>::OnKeyDown(HWND hWnd, UINT key)
{
	ImagePlotImplT *pT=static_cast<ImagePlotImplT*>(this);
