...
public:
	...
	virtual void		SetCustomRect(RECT rect)
	{
		m_IsCustomRect = true;
		m_CustomRect = rect;
	}
...
protected:
	void				DrawTextInRect(HDC hDC, RECT rect, tstring title, LOGFONT logFont, int backmode, COLORREF color);
	...
	void				DrawPlotEdge( HDC hDC, RECT destRect );
...
public:
	...
	virtual	RECT		GetTitleRect( HDC hDC, RECT clientRect, RECT chartRect );
	virtual	RECT		GetSubtitleRect( HDC hDC, RECT chartRect);
