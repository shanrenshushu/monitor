...
Declare_CDblBufferPlotImplI( ShareXChartID1, CShareXPlotImpl, CShareXHandler )
typedef ShareXChartID1<CShareXPlotImpl> ShareXChartID;

typedef CImagePlotImpl	ImageChart;
typedef CImagePlotImplI ImageChartI;
Declare_CDblBufferPlotImplI( ImageChartID1, CImagePlotImpl, CImageHandler )
typedef ImageChartID1<CImagePlotImpl> ImageChartID;
